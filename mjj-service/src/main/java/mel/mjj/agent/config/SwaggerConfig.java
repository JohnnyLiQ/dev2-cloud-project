...
public class SwaggerConfig {
	...
	public static String CONTROLLER_URL="mel.mjj.agent.controller";    //Swagger扫描的接口路径
	public static String SWAGGER_TITLE="API文档-liq"; 	    		//Swagger接口文档标题
